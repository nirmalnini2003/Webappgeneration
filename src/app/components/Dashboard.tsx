...
export function Dashboard({ currentUser, requests }: DashboardProps) {
  ...
  const getStats = () => {
    ...
    if (currentUser.role === 'requester') {
      filteredRequests = requests.filter(r => r.submitter === currentUser.name);
    } else if (currentUser.role !== 'final_approver' && currentUser.role !== 'admin') {
